...
namespace Overdrive.ProBuilderPlus
{
    ...
    public class ConnectEdgesPreviewAction : PreviewMenuAction
    {
        ...
        public override VisualElement CreateSettingsContent()
        {
            ...
            m_ConnectionPosition = Overdrive.ProBuilderPlus.UserPreferences.ConnectionPosition;
            m_Direction = (ConnectionDirection)Overdrive.ProBuilderPlus.UserPreferences.ConnectionDirection;
            m_Mode = (ConnectionMode)Overdrive.ProBuilderPlus.UserPreferences.ConnectionMode;
            ...
            positionField.RegisterValueChangedCallback(evt =>
            {
                ...
                if (m_ConnectionPosition != newValue)
                {
                    ...
                    Overdrive.ProBuilderPlus.UserPreferences.ConnectionPosition = newValue;
            ...
            directionField.RegisterValueChangedCallback(evt =>
            {
                if (m_Direction != (ConnectionDirection)evt.newValue)
                {
                    ...
                    Overdrive.ProBuilderPlus.UserPreferences.ConnectionDirection = (int)(ConnectionDirection)evt.newValue;
                    PreviewActionFramework.RequestPreviewUpdate();
                }
            });
            ...
            modeField.RegisterValueChangedCallback(evt =>
            {
                if (m_Mode != (ConnectionMode)evt.newValue)
                {
                    ...
                    Overdrive.ProBuilderPlus.UserPreferences.ConnectionMode = (int)(ConnectionMode)evt.newValue;
